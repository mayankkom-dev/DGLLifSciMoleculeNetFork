...
def run_a_train_epoch(args, epoch, model, data_loader, loss_criterion, optimizer):
    ...
    wandb.log({f"EpAUCTrain":train_score, "epoch":epoch+1})
...
def main(args, exp_config, train_set, val_set, test_set):
    ...
    print('train {} {:.4f}'.format(args['metric'], train_score))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', choices=['MUV', 'BACE', 'BBBP', 'ClinTox', 'SIDER',
                        ...
                        help='Dataset to use')
    parser.add_argument('-wb', '--wandb', type=str, default='moleculenet-clf',
                        help='WandB Project Name (default: moleculenet-clf)')
    ...
    print(f"Train Size: {len(train_set)}, Val_Size: {len(val_set)},  Test Size:{len(test_set)}")
